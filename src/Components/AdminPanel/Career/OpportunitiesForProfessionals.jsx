...
const Blogslist = DB.collection('Opportunities For Professionals');
const storage = fb.storage();

const OpportunitiesForProfessionals = () => {
  ...
  useEffect(() => {
    ...
    fb.auth().onAuthStateChanged(function (user) {
      if (user) {
        id = user.uid;
        navigate('/career/opportunities-for-professionals');
        console.log("uid", id);
      } else {
...
export default OpportunitiesForProfessionals
